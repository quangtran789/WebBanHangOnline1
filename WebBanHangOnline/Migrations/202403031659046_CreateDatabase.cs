    ...
    public partial class CreateDatabase : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        SepTitle = c.String(maxLength: 150),
                ...
                c => new
                    {
                        ...
                        CategoryId = c.Int(nullable: false),
                        SepTitle = c.String(maxLength: 250),
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.db_Product", t => t.ProductId, cascadeDelete: true)
                .Index(t => t.OrderId)
                .Index(t => t.ProductId);
                ...
                c => new
                    {
                        ...
                        SepTitle = c.String(),
                        SeoDescription = c.String(maxLength: 250),
                        SeoKeywords = c.String(maxLength: 500),
                        CreatedBy = c.String(),
                        CreatedDate = c.DateTime(nullable: false),
                        ModifierBy = c.String(),
                        ModifierDate = c.DateTime(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.tb_ProductImage", "ProductId", "dbo.db_Product");
            DropForeignKey("dbo.db_Product", "ProductCategoryId", "dbo.tb_ProductCategory");
            DropForeignKey("dbo.tb_OrderDetail", "ProductId", "dbo.db_Product");
            ...
            DropIndex("dbo.db_Product", new[] { "ProductCategoryId" });
